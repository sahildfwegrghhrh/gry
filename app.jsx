    ...
    try {
        ...
        mysqlPool.query(sql, values, (mysqlErr, mysqlResult) => {
            if (mysqlErr) {
                ...
                return res.json({ mysqlError: "Error in MySQL database operation", mysqlDetails: mysqlErr.message });
            }
        ...
        return res.json({ error: "Error in database operation", details: error.message });
    }
});
